...
<form method="post" action="<?php echo esc_url( admin_url( 'admin-post.php' ) ); ?>">
	...
	<div class="fusion-white-label-option">
		...
		<div class="fusion-white-label-option-input">
			...
			$avada_submenus = array(
				...
				'support'        => __( 'Support / FAQ', 'fusion-white-label-branding' ),
	...
	<?php if ( class_exists( 'FusionCore_Plugin' ) ) : ?>
		<div class="fusion-white-label-option">
			<div class="fusion-white-label-option-title">
				<?php /* translators: Avada */ ?>
				<h3><?php printf( esc_html__( 'Rename %s Post Type Menus', 'fusion-white-label-branding' ), 'Avada' ); ?></h3>
				<?php /* translators: Avada */ ?>
	...
	<div class="fusion-white-label-option">
		<div class="fusion-white-label-option-title">
			<h3><?php esc_html_e( 'Remove Changelog From Welcome Screen', 'fusion-white-label-branding' ); ?></h3>
			<p class="description"><?php esc_html_e( 'Removes the changelog expandable from the welcome screen.', 'fusion-white-label-branding' ); ?></p>
		</div>
		<div class="fusion-white-label-option-input">
			<div class="fusion-branding-option-field">
				<div class="fusion-form-radio-button-set ui-buttonset">
					<?php $remove_changelog = isset( $avada_options['remove_changelog'] ) ? $avada_options['remove_changelog'] : '0'; ?>
					<input type="hidden" class="button-set-value" value="<?php echo esc_attr( $remove_changelog ); ?>" name="fusion_branding[avada][remove_changelog]" id="remove_changelog" />
					<a data-value="1" class="ui-button buttonset-item<?php echo ( $remove_changelog ) ? ' ui-state-active' : ''; ?>" href="#"><?php esc_html_e( 'Yes', 'fusion-white-label-branding' ); ?></a>
					<a data-value="0" class="ui-button buttonset-item<?php echo ( ! $remove_changelog ) ? ' ui-state-active' : ''; ?>" href="#"><?php esc_html_e( 'No', 'fusion-white-label-branding' ); ?></a>
				</div>
			</div>
		</div>
	</div>	
	...
	<div class="fusion-white-label-option">
		<div class="fusion-white-label-option-title">
			<h3><?php esc_html_e( 'Change Social Media Links', 'fusion-white-label-branding' ); ?></h3>
		...
		<div class="fusion-white-label-option-input">
			...
			$saved_social_media = isset( $avada_options['reset_social_media'] ) ? $avada_options['reset_social_media'] : array();

...
<form method="post" action="<?php echo esc_url( admin_url( 'admin-post.php' ) ); ?>">
	...
	<div class="fusion-white-label-option">
		<div class="fusion-white-label-option-title">
			<h3><?php esc_html_e( 'Disable Fusion Live Builder', 'fusion-white-label-branding' ); ?></h3>
			<p class="description"><?php esc_html_e( 'Set to "yes" to disable all references to the live builder.', 'fusion-white-label-branding' ); ?></p>
		</div>
		<div class="fusion-white-label-option-input">
			<div class="fusion-branding-option-field">
				<div class="fusion-form-radio-button-set ui-buttonset">
					<?php $disable_live_builder = isset( $fusion_builder_options['disable_live_builder'] ) ? $fusion_builder_options['disable_live_builder'] : '0'; ?>
					<input type="hidden" class="button-set-value" value="<?php echo esc_attr( $disable_live_builder ); ?>" name="fusion_branding[fusion_builder][disable_live_builder]" id="disable_live_builder" />
					<a data-value="1" class="ui-button buttonset-item<?php echo ( $disable_live_builder ) ? ' ui-state-active' : ''; ?>" href="#"><?php esc_html_e( 'Yes', 'fusion-white-label-branding' ); ?></a>
					<a data-value="0" class="ui-button buttonset-item<?php echo ( ! $disable_live_builder ) ? ' ui-state-active' : ''; ?>" href="#"><?php esc_html_e( 'No', 'fusion-white-label-branding' ); ?></a>
				</div>
			</div>
		</div>
	</div>
	...
	<div class="fusion-white-label-option">
		...
		<div class="fusion-white-label-option-input">
			...
			$fusion_builder_submenus = array(
				...
				'support'  => esc_html__( 'Support / FAQ', 'fusion-white-label-branding' ),
				...
				'layouts'  => esc_html__( 'Theme Builder', 'fusion-white-label-branding' ),
